...
<%
	...
	List<Xsz> xszs = ServiceFactory.getTeacherServiceInstance().getOneGroups(Integer.valueOf(zuhao));
	List<Student> students = new ArrayList<Student>();
	for (Xsz xsz : xszs) {
		students.add(ServiceFactory.getStudentServiceInstance().getStudentByAccount(xsz.getXuehao()));
	}
%>
<!DOCTYPE html>
<html>
		...
		<div class="contents" style="margin: 0 auto; float: none;">
			...
			<div class="grid_wrapper">
				...
				<div class="g_6 contents_header">
					<h3 class="i_16_dashboard tab_label">查看小组学生详细内容</h3>
					<div>
						<span class="label">对小组的成果进行评优打分</span>
					</div>
				</div>
				...
				<div class="g_12">
					<div class="widget_header">
						<h4 class="widget_header_title wwIcon i_16_forms"><%=student.getName()%>同学的详细内容
						</h4>
					</div>
 ...
 %>
						...
						<div class="line_grid">
							...
							<div class="g_9">
								...
								%>
								<a target="_blank"
									href="pyp.do?meth=rwsP&number=<%=request.getParameter("number")%>"><input
									type="button" value="预览" class="submitIt simple_buttons" /></a> <a
									target="_blank"
									href="pyp.do?meth=rwsL&number=<%=request.getParameter("number")%>"><input
						...
						<div class="line_grid">
							...
							<div class="g_9">
								...
								%>
								<a target="_blank"
									href="pyp.do?meth=ktbgP&number=<%=request.getParameter("number")%>"><input
									type="button" value="预览" class="submitIt simple_buttons" /></a> <a
									target="_blank"
									href="pyp.do?meth=ktbgL&number=<%=request.getParameter("number")%>"><input
									type="button" value="下载" class="submitIt simple_buttons" /></a>
								<%
									} else {
						...
						<div class="line_grid">
							...
							<div class="g_9">
								...
								%>
								<a target="_blank"
									href="pyp.do?meth=lwP&number=<%=request.getParameter("number")%>"><input
									type="button" value="预览" class="submitIt simple_buttons" /></a> <a
									target="_blank"
									href="pyp.do?meth=lwL&number=<%=request.getParameter("number")%>"><input
									type="button" value="下载" class="submitIt simple_buttons" /></a>
								<%
									} else {
						...
						<div class="line_grid">
							...
							<div class="g_9">
								<a target="_blank"
									href="pyp.do?meth=lwsP&id=<%=lws.get(x).getId()%>"><input
				...
				<div class="g_12">
					<div class="widget_header">
						<h4 class="widget_header_title wwIcon i_16_forms">评优日志和打分</h4>
					</div>
					<div class="widget_contents noPadding">
						<div class="line_grid">
							<div class="g_3">
							...
							<input type="hidden" id="sNum"
								value="<%=request.getParameter("zuhao")%>" />
						</div>
						<div class="line_grid">
							<div class="g_3">
							...
							<div class="g_9">
								<input id="fs" class="simple_field" placeholder="满分100"
									type="text" />
							</div>
						</div>
						<div class="line_grid">
	...
	<!-- 页面操作js -->
	<script src="pyry/Javascript/detail.js"></script>
</body>
</html>