...
<%
	...
	List<Yxlw> lws = ServiceFactory.getTeacherServiceInstance().getYxSYxlwsORderXuehao(teacher);
	List<Pyrz> rzs = ServiceFactory.getTeacherServiceInstance().getYxTeacherPyrzOrderbyXuehao(teacher);
	List<Yxlwz> zlws = ServiceFactory.getTeacherServiceInstance().getYxsYxlwzsOrderZuhao(teacher);
	List<Pyrz> zrzs = ServiceFactory.getTeacherServiceInstance().getYxTeacherPyrzOrderZuhao(teacher);
%>
<!DOCTYPE html>
<html>
<head>
