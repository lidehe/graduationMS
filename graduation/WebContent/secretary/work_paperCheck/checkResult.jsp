	   ...
	   <div class="g_12  menu_bar">
		...
		<div class="grid_wrapper">
			<div class="g_12">
				...
				<div class="pageBTNS">
					<a href="../../PaperCheck.do?method=pageSearch&pageNum=<%=pageNum%>&option=pre&requestFrom=pageXs">上一页</a>
			...
			<!-- 论文抽检成绩列表面板 -->
		<div id="chengJiPanel"style="width:600px;min-height:450px;left:250px;top:-30px;position:absolute;background-color:#E6E6FA;">
		 <div class="g_12">
				<div class="widget_header">
				...
				<br></br>
				<div style="color: #9D9D9D;margin-buttom:20px;margin-left:260px;">
