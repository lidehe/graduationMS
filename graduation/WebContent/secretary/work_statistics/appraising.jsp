...
<div class="contents">
	...
	<input type="hidden" id="pageSwitch" value="appraising.jsp" />
	...
	<div class="grid_wrapper">
		...
		<div class="g_12  menu_bar">
			...
			<span class=" active_initialHeadTabs" onclick="initialTabClick(this)">省优秀论文</span>
		</div>
		<div class="g_12">
			<div class="grid_wrapper">
				<div class="widget_header">
					<h4 class="widget_header_title initialDataTile">本院省优秀论文推荐分布统计</h4>
				</div>
