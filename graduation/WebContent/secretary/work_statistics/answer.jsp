...
<div class="contents">
	...
	<input type="hidden" id="pageSwitch" value="answer.jsp" />
	...
	<div class="grid_wrapper">
		...
		<div class="g_12  menu_bar">
			...
			<span class=" active_initialHeadTabs" onclick="initialTabClick(this)">答辩状态</span>
		...
		<div class="g_12">
			<div class="grid_wrapper">
				<div class="widget_header">
					<h4 class="widget_header_title initialDataTile">本院答辩状态分布统计</h4>
				</div>
