...
<div class="contents">
	...
	<input type="hidden" id="pageName" value="statistics.jsp" /> <input
		type="hidden" id="pageSwitch" value="score.jsp" />
	...
	<div class="grid_wrapper">
		...
		<div class="g_12  menu_bar">
			...
			<span class=" active_initialHeadTabs" onclick="initialTabClick(this)">毕设成绩</span>
		...
		<div class="g_12">
			<div class="grid_wrapper">
				<div class="widget_header">
					<h4 class="widget_header_title initialDataTile">本院毕设总分分布统计</h4>
				</div>
