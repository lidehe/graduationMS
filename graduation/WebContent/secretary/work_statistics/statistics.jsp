...
<div class="contents">
    ...
    <input type="hidden" id="pageSwitch" value="ktDistri.jsp" />
	<div class="grid_wrapper">
		...
		<div class="g_12  menu_bar">
			<span class=" active_initialHeadTabs" onclick="initialTabClick(this)">选题分布</span>
		...
		<div class="g_12">
			...
			<div class="grid_wrapper">
				<div class="widget_header">
					<h4 class="widget_header_title initialDataTile">本院课题选用分布统计</h4>
				</div>
