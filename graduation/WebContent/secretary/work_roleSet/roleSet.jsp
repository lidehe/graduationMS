...
<div id="roleSet" class="contents">
	...
	<div class="grid_wrapper">
		...
		<div class="g_12">
			<div class="g_12">
				<input type="hidden" class="requireFrom" value="mishu" /> <span
			...
			<!--因专业负责人没法和专业绑定，所以此处先不做  -->
			<div class="g_12 " id="zhuanyeChoose">
				<span style="color: #9D9D9D">专业选择： </span> <select id="zhuanye"
					style="color: #9D9D9D">
					<option value="0">请选择</option>
				</select>
			</div>
			<!--按工号搜索，仅当角色由行政人员担任时  -->
			<div class="g_12">
				<button style="background-color: #1874CD; color: #ffffff;"
					id="allThisYx">本院所有教师</button>
			</div>
			<!--按工号搜索，仅当角色由行政人员担任时  -->
			<div class="g_12">
			...
			<div class="g_12">
				...
				<div class="g_6">
					...
					<div class="pageBTNS">
						<span class="pageOption">上一页</span>&nbsp;&nbsp;第<span id="nowPage">0</span>/<span id="totalPage">0</span>页&nbsp;&nbsp;页<span class="pageOption">下一页</span>
					</div>
				</div>
