...
<div class="contents">
	<!-- 标记本页面名字，用于左侧菜单背景色变化 -->
	<input type="hidden" id="pageName" value="history.jsp" /> <input
		type="hidden" id="pageId" value="appraising" />
	<div class="grid_wrapper">
		...
		<div class="g_12  menu_bar">
			...
			<span class=" active_initialHeadTabs" onclick="initialTabClick(this)">往届评优信息</span>
		...
		<div class="g_12">
			...
			<div class="g_12">
				<button id="appraisingBTN" class="SearchBTN">开始查询</button>
			</div>
			<div class="grid_wrapper">
