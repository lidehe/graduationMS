...
<div class="contents">
	...
	<div class="grid_wrapper">
		...
		<div class="g_12  menu_bar">
			...
			<span class=" active_initialHeadTabs" onclick="initialTabClick(this)">导入教师信息</span>
		...
		<div class="g_12" >
			...
			<div class="g_12">
				<div class="widget_header">
					<h4 class="widget_header_title wwIcon">
						<span class="initial_remind">导入教师信息</span>
					</h4>
				</div>
				<!-- 隐藏的用于向后台传送所传的是哪个群体的文件 -->
				<input class="initial_inforSource" name="inforSource" type="hidden" value="教师信息"/>
			...
			<div align="center">
			    可前往&gt;&gt;<a href="../work_teacherAndStudentInfor/teacherInfor.jsp">师生信息管理</a>&lt;&lt;&nbsp;查看和管理<span style="color:red;">教职工</span>信息
			</div>
			<br>
		</div>
