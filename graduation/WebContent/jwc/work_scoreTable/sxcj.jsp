...
<div id="roleSet" class="contents">
	...
	<input type="hidden" id="pageName" value="scoreTable.jsp" /> <input
		type="hidden" id="pageSwitch" value="sxcj.jsp" />
	...
	<div class="grid_wrapper">
		...
		<div class="g_12  menu_bar">
			...
			<span class=" active_initialHeadTabs" onclick="initialTabClick(this)">实习成绩表</span>
		</div>
		<!-- 上传院系信息 -->
		<div class="g_12">
			<div class="g_12">
				...
				<div class="g_12">
					<div class="widget_header">
						<h4 class="widget_header_title ">实习成绩表已有项目</h4>
					</div>
