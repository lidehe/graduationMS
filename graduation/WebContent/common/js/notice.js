...
$(function() {
	...
	$(".reNoticeZd").click(function() {// 点击发布“指导老师”公告
		releaseNotice("home.do?meth=addZd");
	});
	$(".reNoticeZy").click(function() {// 点击发布“专业”公告
		releaseNotice("home.do?meth=addZy");
	});
	$(".reNoticeYx").click(function() {// 点击发布“院”公告
		releaseNotice("home.do?meth=addYx");
	});
