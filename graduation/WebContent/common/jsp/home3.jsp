...
<%
	...
	List<Notice> noticesYx = ServiceFactory.getTeacherServiceInstance().getYxNotices(teacher);
	List<Notice> noticesZy = ServiceFactory.getTeacherServiceInstance().getZyNotices(teacher);
	List<Notice> noticesZd = ServiceFactory.getTeacherServiceInstance().getZdNotices(teacher);
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="wrapper">
			<div class="user">
				<img src="student/Images/user_avatar.png" alt="user_avatar"
					...
					title="修改密码"><span style="color: #21c4e0;"><%=teacher.getName()%></span>老师，您好</span>
