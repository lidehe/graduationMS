...
<%
	...
	int sideInd = 6;//侧边栏的序号，需要确定的赋值；与sidebar对应

	Teacher teacher = (Teacher) request.getSession().getAttribute("teacher");
	List<Student> students = ServiceFactory.getTeacherServiceInstance().getTeachersStudentOrderXuehao(teacher);
	List<Boolean> newMessage = ServiceFactory.getTeacherServiceInstance().checkNewMessage(students, teacher);
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="contents">
			...
			<div class="grid_wrapper">
				...
				<div class="g_6 contents_header">
					<h3 class="i_16_dashboard tab_label">师生交流</h3>
					<div>
						<span class="label">在任一阶段都可以给学生发送消息</span>
					</div>
				</div>
				...
				<div class="g_12">
					<div class="widget_header">
						<h4 class="widget_header_title wwIcon i_16_tables">学生列表及新消息提示</h4>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align: center;"><div
											...
											<a
												href="tssjl.do?meth=detail&number=<%=students.get(i).getNumber()%>"
												target="_blank">&nbsp;&nbsp;详&nbsp;情&nbsp;&nbsp;</a>
										</div></td>
								</tr>
								<%
