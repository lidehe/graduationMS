...
<%
	...
	int sideInd = 5;//侧边栏的序号，需要确定的赋值；与sidebar对应
...
<body>
		...
		<div class="contents">
			...
			<div class="grid_wrapper">
				...
				<div class="g_6 contents_header">
					<h3 class="i_16_dashboard tab_label"><%=byfs.getShisi()%>
						<%
							if (byfs.getStart5() != null && byfs.getEnd5() != null)
								out.print("(" + new Date(byfs.getStart5().getTime()) + "~" + new Date(byfs.getEnd5().getTime()) + ")");
						%>
					</h3>
					<div>
						<span class="label">请向指导老师确认后再提交最终成果<!-- <span
							style="color: #fd1d1d">，一即提交不可修改！</span> --></span>
					</div>
				</div>
				...
				<div class="g_12">
					<div class="widget_header">
						<h4 class="widget_header_title wwIcon i_16_forms">
							请按照指导老师要求提交最终成果，不超过20M的PDF文件！</h4>
					</div>
					<div class="widget_contents noPadding">
						...
						<div class="line_grid">
							...
							<div class="g_9">
								<a target="_blank" title="阅览" href="preview.do?meth=lw"><%=lw.getFileName()%></a>
								&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="lwLoad">下载</a>
							</div>
						</div>
						<%
							}
						%>
						<div class="line_grid">
							<form id="lwwj" enctype="multipart/form-data">
								<div class="g_3">
				...
				<div class="g_12">
					<div class="widget_header">
						<h4 class="widget_header_title wwIcon i_16_forms">最终成果附件（每个不超过20M，最多三个）</h4>
					</div>
					<div class="widget_contents noPadding newLine">
						...
						<div class="line_grid">
							<form class="jdxcgswj" enctype="multipart/form-data">
								<input type="hidden" name="jId" value="<%=lws.get(i).getId()%>" />
								<div class="g_4">
									<span class="label"><%=lws.get(i).getFileName()%>： </span>
								</div>
								<div class="g_4">
								...
								<div class="g_2" style="text-align: center;">
									<div class="simple_buttons">
										<div
											onclick="window.open('preview.do?meth=lwsLoad&id=<%=lws.get(i).getId()%>');">查&nbsp;看</div>
									</div>
								</div>
							</form>
						</div>
	...
	<!-- 页面操作js -->
	<script src="student/Javascript/lw.js"></script>
</body>
</html>